...
import eu.dreamix.four_for_belot.domain.Location;
import eu.dreamix.four_for_belot.repository.LocationRepository;
import eu.dreamix.four_for_belot.service.LocationService;
import eu.dreamix.four_for_belot.service.dto.LocationDTO;
import eu.dreamix.four_for_belot.service.mapper.LocationMapper;
...
public class LocationResourceIntTest {
    ...
    public void createLocation() throws Exception {
        ...
        assertThat(testLocation.getUrl()).isEqualTo(DEFAULT_URL);
    }
    ...
    @Test
    @Transactional
    public void checkLongtitudeIsRequired() throws Exception {
        int databaseSizeBeforeTest = locationRepository.findAll().size();
        // set the field null
    ...
    public void updateLocation() throws Exception {
        ...
        assertThat(testLocation.getUrl()).isEqualTo(UPDATED_URL);
    }
