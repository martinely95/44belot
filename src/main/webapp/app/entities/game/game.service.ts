...
export class GameService {
    ...
    private convert(game: Game): Game {
        ...
        copy.createdDateTime = this.dateUtils.toDate(game.createdDateTime);

        copy.startDateTime = this.dateUtils.toDate(game.startDateTime);

        copy.endDateTime = this.dateUtils.toDate(game.endDateTime);
        return copy;
    }
}
